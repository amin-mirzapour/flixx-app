const global = {
  ...
  api: {
    apiKey: '5fa3d259c28fb60014fad8508bf503ed',
...
async function displayMovieDetails() {
  ...
  <div class="details-top">
        ...
        <div class="details-bottom">
          <h2>Movie Info</h2>
          <ul>
            <li><span class="text-secondary">Budget:</span> $${addCommosToNumber(
              movie.budget
            )}</li>
            <li><span class="text-secondary">Revenue:</span> $${addCommosToNumber(
              movie.revenue
            )}</li>
...
async function search() {
  ...
  if (global.search.term !== '' && global.search.term !== null) {
    ...
    showAlert('Please fill out ther form first');
  }
}
...
function addCommosToNumber(number) {
